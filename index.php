         ...
         <div class="container-fluid bg-grey">
            <div class="row">
               ...
               <div class="col-sm-8">
                  <h2>Our Values</h2>
                  <br>
                  <h4><strong>MISSION:</strong> Our mission is using one platform for examinations. Reduce paperwork and offering quick and accurate results. </h4>
                  <br>
                     ...
                     <form class="form-horizontal" action="login.php?q=index.php" method="POST">
                        <fieldset>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-md-6">
                                 <input id="email" name="email" placeholder="Enter your username" class="form-control input-md" type="text">
                              </div>
                           </div>
                           <!-- Password input-->
                           <div class="form-group">
